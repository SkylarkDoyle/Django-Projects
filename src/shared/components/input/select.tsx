...
const Select = ({ children, label, name, onChange, value, required, small, errorMessage, isEmpty, className, selectRef, ...props }: SelectProps) => (
  <Form.MainLabelContainer className={className} ref={selectRef}>
    ...
    <Form.Select name={name} onChange={onChange} value={value} isEmpty={isEmpty} errorMessage={errorMessage} {...props}>
      {children}
    </Form.Select>
